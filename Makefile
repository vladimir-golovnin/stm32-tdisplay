...
LFLAGS_STM32=$(LFLAGS) main.c delay.c lcd1602.c sys.c display.c -T ld.stm32.basic
...
out.elf: main.c delay.c delay.h lcd1602.h lcd1602.c sys.c display.c display.h libopencm3/lib/libopencm3_stm32f1.a
